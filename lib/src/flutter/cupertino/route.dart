...
/// modify from https://github.com/flutter/flutter/blob/stable/packages/flutter/lib/src/cupertino/route.dart
/// lastest commit: 2021.03.30
/// https://github.com/flutter/flutter/commit/a6832d4d3244fd0c72f2b13dc8c5620c2e55989b
/// #58511 https://github.com/flutter/flutter/pull/79299
/// flutter v2.2.2
///
...
mixin CupertinoRouteTransitionMixin<T> on PageRoute<T> {
  ...
  double backGestureWidth = _kBackGestureWidth;
...
class CupertinoPageRoute<T> extends PageRoute<T> with CupertinoRouteTransitionMixin<T> {
  ...
  /// the backGestureWidth, default is 20.0.
  /// can set to MediaQuery.of(context).size.with
  @override
