...
/// Base wrapper for CNBottomToolbar with cross-platform support
/// 
/// Provides native iOS bottom toolbar with expandable search with fallback to Material Design
/// app bar or bottom app bar on other platforms. Uses the cupertino_native package for true
/// native iOS toolbar experience when available.
/// 
/// Features:
...
/// )
/// ```
class BaseCNBottomToolbar extends BaseStatelessWidget {
...
/// 
/// This maintains the original API while delegating to BaseCNBottomToolbar
