...
class BaseTextField extends BaseStatelessWidget {
  ...
  Widget buildByCupertino(BuildContext context) {
    return CupertinoTextField(
      ...
      cursorWidth: valueOf('cursorWidth', cursorWidth) ?? 2.0,
      cursorHeight: valueOf('cursorHeight', cursorHeight),
      cursorRadius: valueOf('cursorRadius', cursorRadius) ?? const Radius.circular(2.0),
      cursorColor: valueOf('cursorColor', cursorColor),
      selectionHeightStyle: valueOf('selectionHeightStyle', selectionHeightStyle) ?? ui.BoxHeightStyle.tight,
      selectionWidthStyle: valueOf('selectionWidthStyle', selectionWidthStyle) ?? ui.BoxWidthStyle.tight,
      keyboardAppearance: valueOf('keyboardAppearance', keyboardAppearance),
      scrollPadding: valueOf('scrollPadding', scrollPadding) ?? const EdgeInsets.all(20.0),
      dragStartBehavior: valueOf('dragStartBehavior', dragStartBehavior) ?? DragStartBehavior.start,
      enableInteractiveSelection: valueOf('enableInteractiveSelection', enableInteractiveSelection) ?? true,
