...
class _CNNativeSheetDemoState extends State<CNNativeSheetDemo> {
  ...
  Future<void> _showSettingsSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        ...
        const BaseSheetItem(title: 'Privacy', iosIcon: 'hand.raised'),
      ],
  ...
  Future<void> _showActionsSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      title: 'Photo Actions',
      items: [
        const BaseSheetItem(title: 'Share Photo', iosIcon: 'square.and.arrow.up'),
        const BaseSheetItem(title: 'Add to Album', iosIcon: 'plus.rectangle.on.rectangle'),
        const BaseSheetItem(title: 'Edit Photo', iosIcon: 'paintbrush'),
        const BaseSheetItem(title: 'Copy Photo', iosIcon: 'doc.on.clipboard'),
        const BaseSheetItem(title: 'Delete Photo', iosIcon: 'trash'),
      ],
  ...
  Future<void> _showLargeSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        const BaseSheetItem(title: 'Create New', iosIcon: 'plus'),
        const BaseSheetItem(title: 'Import File', iosIcon: 'square.and.arrow.down'),
        const BaseSheetItem(title: 'Export Data', iosIcon: 'square.and.arrow.up'),
        const BaseSheetItem(title: 'Sync Settings', iosIcon: 'arrow.triangle.2.circlepath'),
        const BaseSheetItem(title: 'Backup Data', iosIcon: 'icloud.and.arrow.up'),
        const BaseSheetItem(title: 'Reset App', iosIcon: 'arrow.counterclockwise'),
        const BaseSheetItem(title: 'Help & Support', iosIcon: 'questionmark.circle'),
        const BaseSheetItem(title: 'About', iosIcon: 'info.circle'),
      ],
      detents: [CNSheetDetent.large],
      prefersGrabberVisible: true,
    );
  ...
  Future<void> _showFormatSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        ...
        const BaseSheetItem(title: 'Underline', iosIcon: 'underline', dismissOnTap: false),
        const BaseSheetItem(title: 'Strikethrough', iosIcon: 'strikethrough'),
      ],
  ...
  Future<void> _showToolsPalette() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      title: 'Drawing Tools',
      items: [
        const BaseSheetItem(title: 'Pencil', iosIcon: 'pencil', dismissOnTap: false),
        const BaseSheetItem(title: 'Brush', iosIcon: 'paintbrush', dismissOnTap: false),
        const BaseSheetItem(title: 'Eraser', iosIcon: 'eraser', dismissOnTap: false),
        const BaseSheetItem(title: 'Text', iosIcon: 'textformat'),
      ],
  ...
  Future<void> _showPreferencesSheet() async {
    final selectedIndex = await BaseNativeSheet.showWithCustomHeader(
      ...
      closeButtonSize: 20,
      items: [
        const BaseSheetItem(title: 'General', iosIcon: 'gear'),
        const BaseSheetItem(title: 'Account', iosIcon: 'person.circle'),
        const BaseSheetItem(title: 'Security', iosIcon: 'lock'),
        const BaseSheetItem(title: 'Advanced', iosIcon: 'slider.horizontal.3'),
      ],
      detents: [CNSheetDetent.medium],
    );
  ...
  Future<void> _showCustomHeightSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        const BaseSheetItem(title: 'Action 1', iosIcon: 'circle'),
        const BaseSheetItem(title: 'Action 2', iosIcon: 'square'),
        const BaseSheetItem(title: 'Action 3', iosIcon: 'triangle'),
      ],
      detents: [CNSheetDetent.custom(280)],
      prefersGrabberVisible: true,
  ...
  Future<void> _showMultipleDetentsSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        const BaseSheetItem(title: 'Small Task', iosIcon: 'checkmark'),
        const BaseSheetItem(title: 'Medium Task', iosIcon: 'checkmark.circle'),
        const BaseSheetItem(title: 'Large Task', iosIcon: 'checkmark.circle.fill'),
        const BaseSheetItem(title: 'Extra Task', iosIcon: 'plus.circle'),
        const BaseSheetItem(title: 'Bonus Task', iosIcon: 'star.circle'),
      ],
  ...
  Future<void> _showStyledSheet() async {
    final selectedIndex = await BaseNativeSheet.show(
      ...
      items: [
        const BaseSheetItem(title: 'Primary Action', iosIcon: 'star'),
        const BaseSheetItem(title: 'Secondary Action', iosIcon: 'heart'),
        const BaseSheetItem(title: 'Warning Action', iosIcon: 'exclamationmark.triangle'),
      ],
...
class _CNNativeSheetVariationsDemoState extends State<CNNativeSheetVariationsDemo> {
  ...
  Future<void> _showPhotosStyleSheet() async {
    await BaseNativeSheet.show(
      ...
      title: 'Share Photo',
      items: [
        const BaseSheetItem(title: 'AirDrop', iosIcon: 'airplayaudio'),
        const BaseSheetItem(title: 'Messages', iosIcon: 'message'),
        const BaseSheetItem(title: 'Mail', iosIcon: 'envelope'),
        const BaseSheetItem(title: 'Copy Link', iosIcon: 'link'),
        const BaseSheetItem(title: 'Add to Album', iosIcon: 'plus.rectangle.on.rectangle'),
        const BaseSheetItem(title: 'Duplicate', iosIcon: 'doc.on.doc'),
        const BaseSheetItem(title: 'Hide', iosIcon: 'eye.slash'),
        const BaseSheetItem(title: 'Delete', iosIcon: 'trash'),
      ],
      detents: [CNSheetDetent.medium, CNSheetDetent.large],
      prefersGrabberVisible: true,
    );
  ...
  Future<void> _showNotesStyleSheet() async {
    await BaseNativeSheet.showWithCustomHeader(
      ...
      items: [
        ...
        const BaseSheetItem(title: 'Italic', iosIcon: 'italic', dismissOnTap: false),
        const BaseSheetItem(title: 'Underline', iosIcon: 'underline', dismissOnTap: false),
        const BaseSheetItem(title: 'Strikethrough', iosIcon: 'strikethrough', dismissOnTap: false),
        const BaseSheetItem(title: 'Title', iosIcon: 'textformat'),
        const BaseSheetItem(title: 'Heading', iosIcon: 'textformat'),
        const BaseSheetItem(title: 'Subheading', iosIcon: 'textformat'),
      ],
  ...
  Future<void> _showMapsStyleSheet() async {
    await BaseNativeSheet.show(
      ...
      items: [
        const BaseSheetItem(title: 'Directions', iosIcon: 'arrow.triangle.turn.up.right.diamond'),
        const BaseSheetItem(title: 'Call', iosIcon: 'phone'),
        const BaseSheetItem(title: 'Website', iosIcon: 'safari'),
        const BaseSheetItem(title: 'Share Location', iosIcon: 'square.and.arrow.up'),
        const BaseSheetItem(title: 'Add to Favorites', iosIcon: 'heart'),
        const BaseSheetItem(title: 'Report an Issue', iosIcon: 'exclamationmark.triangle'),
      ],
      detents: [CNSheetDetent.medium],
      prefersGrabberVisible: true,
    );
  ...
  Future<void> _showFilesStyleSheet() async {
    await BaseNativeSheet.show(
      ...
      title: 'Document.pdf',
      items: [
        const BaseSheetItem(title: 'Quick Look', iosIcon: 'eye'),
        const BaseSheetItem(title: 'Share', iosIcon: 'square.and.arrow.up'),
        const BaseSheetItem(title: 'Copy', iosIcon: 'doc.on.clipboard'),
        const BaseSheetItem(title: 'Duplicate', iosIcon: 'doc.on.doc'),
        const BaseSheetItem(title: 'Move', iosIcon: 'folder'),
        const BaseSheetItem(title: 'Rename', iosIcon: 'pencil'),
        const BaseSheetItem(title: 'Compress', iosIcon: 'archivebox'),
        const BaseSheetItem(title: 'Delete', iosIcon: 'trash'),
      ],
      detents: [CNSheetDetent.large],
      prefersGrabberVisible: true,
  ...
  Future<void> _showSettingsStyleSheet() async {
    await BaseNativeSheet.showWithCustomHeader(
      ...
      items: [
        const BaseSheetItem(title: 'Appearance', iosIcon: 'sun.max'),
        const BaseSheetItem(title: 'Brightness', iosIcon: 'sun.max'),
        const BaseSheetItem(title: 'Auto-Lock', iosIcon: 'lock'),
        const BaseSheetItem(title: 'Text Size', iosIcon: 'textformat.size'),
        const BaseSheetItem(title: 'Display Zoom', iosIcon: 'plus.magnifyingglass'),
      ],
      detents: [CNSheetDetent.medium],
      prefersGrabberVisible: false,
    );
